(function(W) {
    ...
    function h() {
        ...
        function r() {
            ...
            H = {
                script: function() {
                    for (var K = 0; K < arguments.length; K++) { (function(M, O) {
                            var L;
                            if (!l(M)) {
                                O = [M]
                            }
                            for (var N = 0; N < O.length; N++) {
                                ...
                                if (l(M)) {
                                    L = [].slice.call(M);
                                    L.unshift(N, 1); [].splice.apply(O, L);
                                    N--;
                                    continue
                                }
                                if (typeof M == "string") {
    ...
    var c = {
        decodeHtml: function(l) {
            ...
            return (typeof l != "string") ? l: l.replace(/&\w+;|&#(\d+);/g,
            function(o, n) {
                var p = m[o];
                if (p === undefined) {
                    if (!isNaN(n)) {
    ...
    var g = {
        ...
        extend: function() {
            ...
            return function(p, o) { (typeof p == "function") || (p = function() {});
                var m = function() {
    ...
    var e = {
        require: function(l, m) { ! g.isArray(l) && (l = Array(l));
            e.loadJs(l, m)
        },
        loadJs: function(l, m) {
            $LAB.setOptions({
