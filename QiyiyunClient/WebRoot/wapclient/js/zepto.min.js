...
var Zepto = function() {
    ...
    N.init = function(t, r) {
        ...
        var i;
        if (H(t)) i = j(t);
        else if (D(t)) i = [P(t) ? n.extend({},
        t) : t],
        t = null;
        else if (h.test(t)) i = N.fragment(t.trim(), RegExp.$1, r),
        t = null;
        else {
    ...
    n.map = function(e, t) {
        ...
        i,
        s;
        if (B(e)) for (i = 0; i < e.length; i++) n = t(e[i], i),
        n != null && r.push(n);
    ...
    n.fn = {
        ...
        filter: function(e) {
            return O(e) ? this.not(this.not(e)) : n(o.call(this,
            function(t) {
        ...
        parents: function(e) {
            ...
            function(e) {
                if ((e = e.parentNode) && !_(e) && t.indexOf(e) < 0) return t.push(e),
                e
            });
            return X(t, e)
        },
        ...
        show: function() {
            return this.each(function() {
                ...
                l(this, "").getPropertyValue("display") == "none" && (this.style.display = U(this.nodeName))
            })
        },
        ...
        attr: function(n, r) {
            ...
            return typeof n == "string" && r === e ? this.length == 0 || this[0].nodeType !== 1 ? e: n == "value" && this[0].nodeName == "INPUT" ? this.val() : !(i = this[0].getAttribute(n)) && n in this[0] ? this[0][n] : i: this.each(function(e) {
                ...
                else $(this, n, V(this, r, e, this.getAttribute(n)))
            })
        },
        ...
        removeClass: function(t) {
            return this.each(function(n) {
                ...
                r = J(this),
                V(this, t, n, r).split(/\s+/g).forEach(function(e) {
                    r = r.replace(q(e), " ")
                }),
                J(this, r.trim())
            })
    ...
    m.forEach(function(e, t) {
        ...
        n.fn[e] = function() {
            ...
            function(t) {
                return e = A(t),
                e == "object" || e == "array" ? t: N.fragment(t)
            }),
            s,
            o = this.length > 1;
...
function($) {
    ...
    $.ajaxJSONP = function(e) {
        if ("type" in e) {
            ...
            o;
            return serializeData(e),
            ajaxBeforeSend(s, e) === !1 ? (i("abort"), !1) : (window[t] = function(t) {
                r(),
                ajaxSuccess(t, s, e)
            },
            n.onerror = function() {
