...
import com.zhidian.server.model.Manager;
...
/**
	 ...
	 * @see com.zhidian.server.model.Manager
...
public class ManagerDAO extends BaseHibernateDAO  {
	...
	public static final String MANAGER_IS_DELETE = "managerIsDelete";
    ...
    public Manager findById( java.lang.String id) {
        ...
        try {
            Manager instance = (Manager) getSession()
                    .get("com.zhidian.server.model.Manager", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Manager instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.zhidian.server.model.Manager")
	...
	public List findByManagerIsDelete(Object managerIsDelete
	) {
		return findByProperty(MANAGER_IS_DELETE, managerIsDelete
		);
	}
