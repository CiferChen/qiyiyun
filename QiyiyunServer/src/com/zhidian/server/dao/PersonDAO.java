...
/**
	 ...
	 * @see com.zhidian.server.model.Person
...
public class PersonDAO extends BaseHibernateDAO  {
    ...
    public Person findById( java.lang.String id) {
        ...
        try {
            Person instance = (Person) getSession()
                    .get("com.zhidian.server.model.Person", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Person instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.zhidian.server.model.Person")
	...
	public List findByPersonEmail(Object personEmail
	) {
		return findByProperty(PERSON_EMAIL, personEmail
		);
	}
    ...
    public Person merge(Person detachedInstance) {
        ...
        try {
            Person result = (Person) getSession()
