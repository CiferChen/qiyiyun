...
import com.zhidian.server.model.Service;
...
/**
	 ...
	 * @see com.zhidian.server.model.Service
...
public class ServiceDAO extends BaseHibernateDAO  {
		...
		//property constants
	public static final String SEIVICE_GOODS_ID = "seiviceGoodsId";
	public static final String SERVICE_TYPE_ID = "serviceTypeId";
	public static final String SERVICE_BOOK_TIME = "serviceBookTime";
	...
	public static final String SERVICE_IS_DELETE = "serviceIsDelete";
    ...
    public Service findById( java.lang.String id) {
        ...
        try {
            Service instance = (Service) getSession()
                    .get("com.zhidian.server.model.Service", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Service instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.zhidian.server.model.Service")
	...
	public List findBySeiviceGoodsId(Object seiviceGoodsId
	) {
		return findByProperty(SEIVICE_GOODS_ID, seiviceGoodsId
		);
	}
	
	public List findByServiceTypeId(Object serviceTypeId
	) {
		return findByProperty(SERVICE_TYPE_ID, serviceTypeId
		);
	}
	
	public List findByServiceBookTime(Object serviceBookTime
	) {
		return findByProperty(SERVICE_BOOK_TIME, serviceBookTime
		);
	}
	
	public List findByServiceStartTime(Object serviceStartTime
	) {
		return findByProperty(SERVICE_START_TIME, serviceStartTime
		);
	}
	
	public List findByServiceEndTime(Object serviceEndTime
	) {
		return findByProperty(SERVICE_END_TIME, serviceEndTime
		);
	}
	
	public List findByServiceStatus(Object serviceStatus
	) {
		return findByProperty(SERVICE_STATUS, serviceStatus
		);
	}
	
	public List findByServiceIsDelete(Object serviceIsDelete
	) {
		return findByProperty(SERVICE_IS_DELETE, serviceIsDelete
		);
	}
